...
#define TW_STATIC // with SCIGMA, always link statically
...
TW_API int      TW_CALL TwSetCurrentWindow(size_t windowID); // multi-windows support
TW_API size_t   TW_CALL TwGetCurrentWindow();
TW_API int      TW_CALL TwWindowExists(size_t windowID);
