...
/*! @brief Waits for a certain time until events are pending and processes them.
 *
 *  same as glfwWaitEvents, only the function returns after the specified time
 *  if no events were received.
 * 
 *  @ingroup window
 */
GLFWAPI void glfwWaitEventsWithTimeOut(double seconds);
