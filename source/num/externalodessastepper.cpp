...
namespace scigma
{
  namespace num
  {
    ...
    ExternalOdessaStepper::ExternalOdessaStepper(double dt, size_t nVar, size_t nFunc, Odessa::F f, Odessa::DFDX dfdx, F_t fFunc,
						 double t, const double* x, bool stiff, double aTol, double rTol,
						 size_t maxIter):
      Stepper(nVar,nFunc,t),dt_(dt),fFunc_(fFunc),
      odessa_(nVar,f,dfdx,nVar,NULL,stiff,aTol,rTol,maxIter),
