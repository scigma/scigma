...
class Curve(object):
    ...
    lib.scigma_gui_create_curve.argtypes=[c_int,c_char_p,c_int,c_int,c_int,c_int,c_int, 
    ...
    def __init__(self, glWindow,identifier, nPoints, nParts,
                 mesh, varWave, constWave, marker=STAR, point=DOT, markerSize=16.0,
        ...
        self.objectID = lib.scigma_gui_create_curve(glWindow.objectID,identifier,nPoints,nParts,
                                                    mesh.objectID, varWave.objectID,constWave.objectID,
